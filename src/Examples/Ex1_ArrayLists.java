...
public class Ex1_ArrayLists {
    public static void run(){
        ...
        allNames.add("Zoe Saldana"); allDollars.add(14227.7); allOscars.add(true); allFilms.add(31);

        allNames.add(1, "Scarlett Johansson"); allDollars.add(1, 14527.7); allOscars.add(1, false);
        allFilms.add(1, 52);
